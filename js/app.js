...
//Giving function to Up, Down, Right and left key:
...
Player.prototype.update = function(dt) {
   ...
   //Position reset after completing level:
   if (this.y < 0) {
      this.win();
      this.reset();
   }
...
Player.prototype.render = function() {
   ...
   ctx.drawImage(Resources.get(this.sprite), this.x, this.y);
   ctx.font = "15px Arial";
   ctx.fillText("Score: " + this.score, 620, 80);
};
